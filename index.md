...
<input type="hidden" id="_o_dbjbempljhcmhlfpfacalomonjpalpko"><script type="text/javascript" src="cat/inspector.js"></script></head>
<body>
    <script src="cat/phaser.js"></script>
    <script src="cat/catch-the-cat.js"></script>
    <div id="catch-the-cat"><canvas width="0" height="0"></canvas></div>
    <script>
